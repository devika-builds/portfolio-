...
const TOOLS = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <circle cx="14" cy="4.5" r="3" fill="url(#tg1)"/>
        <rect x="9.5" y="7" width="9" height="11" rx="2" fill="url(#tg1)"/>
        <circle cx="20" cy="6" r="2.2" fill="url(#tg2)"/>
        <rect x="16.5" y="8" width="6.5" height="8.5" rx="1.8" fill="url(#tg2)"/>
        <rect x="2.5" y="8" width="10" height="10" rx="1.5" fill="#6264A7"/>
        <path d="M9.5 11.5H5.5v1.2h1.3v3.3h1.4v-3.3h1.3v-1.2z" fill="#fff"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M8.627 1.5H15.373L22.118 13.5H15.373L8.627 1.5Z" fill="#FBBC04"/>
        <path d="M1.882 13.5L8.627 1.5L15.373 13.5H8.627L1.882 13.5Z" fill="#34A853"/>
        <path d="M8.627 13.5L5.255 19.5H18.745L22.118 13.5H8.627Z" fill="#4285F4"/>
        <path d="M15.373 13.5L8.627 1.5L12 7.5L15.373 13.5Z" fill="#188038"/>
        <path d="M8.627 13.5L5.255 19.5L1.882 13.5H8.627Z" fill="#1967D2"/>
        <path d="M15.373 13.5L18.745 19.5L22.118 13.5H15.373Z" fill="#EA4335"/>
      </svg>
    ),
  },
  {
...
const CERT_ICONS = {
  ...
  google: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/>
      <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
      <path d="M5.84 14.09A6.95 6.95 0 015.48 12c0-.72.13-1.43.36-2.09V7.07H2.18A11.96 11.96 0 001 12c0 1.94.46 3.77 1.18 4.93l3.66-2.84z" fill="#FBBC05"/>
      <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
    </svg>
  ),
  linkedin: (
  ...
  ibm: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="#0530AD">
      <path d="M0 7.5h4.819V8.7H0zm0 2.4h4.819v1.2H0zm0 2.4h4.819v1.2H0zm0 2.4h4.819v1.2H0zM6.019 7.5h5.162c1.727 0 2.741.86 2.741 2.34a2.09 2.09 0 01-1.47 2.1 2.2 2.2 0 011.77 2.22c0 1.56-1.08 2.34-2.841 2.34H6.019v-1.2h4.962c1.08 0 1.641-.48 1.641-1.2s-.561-1.2-1.641-1.2H6.019v-1.2h4.962c.96 0 1.541-.42 1.541-1.14s-.581-1.14-1.541-1.14H6.019zm10.181 0h4.962l1.38 2.4h-1.38l-.96-1.2H16.2v1.2h-1.2V7.5h1.2zm0 3.6h4.002l.96 1.2h-1.38l-.54-.6H16.2v.6h-1.2v-1.2h1.2zm0 2.4h4.962l.48.6.48.6h-1.38l-.54-.6H16.2v.6h-1.2v-1.2h1.2z"/>
    </svg>
  ),
  pmi: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <rect x="2" y="2" width="20" height="20" rx="3" fill="#1A1F71"/>
      <text x="12" y="16" textAnchor="middle" fill="#fff" fontSize="10" fontWeight="700" fontFamily="Arial,sans-serif">PMI</text>
    </svg>
  ),
  coursera: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="#0056D2">
      <path d="M11.374.656a12.013 12.013 0 00-8.652 5.14l5.798 3.427a4.785 4.785 0 017.074-1.381l5.7-3.372A12.014 12.014 0 0011.374.656zM1.592 7.472A11.945 11.945 0 000 12.014a12.01 12.01 0 001.593 5.966l5.798-3.428a4.76 4.76 0 010-5.106L1.593 7.472zm20.017-.026l-5.7 3.372a4.76 4.76 0 010 5.106l5.7 3.372a11.95 11.95 0 000-11.85zm-9.235 10.126a4.785 4.785 0 01-5.074-1.382l-5.798 3.428A12.013 12.013 0 0012.626 23.4a12.014 12.014 0 008.752-3.837l-5.7-3.373a4.777 4.777 0 01-3.304 1.308z"/>
    </svg>
  ),
  efset: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <rect x="2" y="2" width="20" height="20" rx="3" fill="#1A73E8"/>
      <text x="12" y="16" textAnchor="middle" fill="#fff" fontSize="8" fontWeight="700" fontFamily="Arial,sans-serif">EF</text>
    </svg>
  ),
};

const CERTS = [
  { name: "Career Essentials in Generative AI", issuer: "Microsoft & LinkedIn", color: "#0078D4", iconKey: "microsoft" },
  { name: "Google Prompting Essentials", issuer: "Google", color: "#34A853", iconKey: "google" },
  { name: "Microsoft 365 Copilot for Work", issuer: "LinkedIn Learning", color: "#0A66C2", iconKey: "linkedin" },
  { name: "Enhance Custom GPTs with Zapier Actions", issuer: "LinkedIn Learning", color: "#FF4A00", iconKey: "linkedin" },
  { name: "Governance, Risk, Compliance & Data Privacy", issuer: "IBM", color: "#0530AD", iconKey: "ibm" },
  { name: "Project Mgmt Foundations: Schedules", issuer: "PMI", color: "#1A1F71", iconKey: "pmi" },
  { name: "Business Analysis & Process Management", issuer: "Coursera", color: "#0056D2", iconKey: "coursera" },
  { name: "Google Workspace Tools", issuer: "Google", color: "#4285F4", iconKey: "google" },
  { name: "EFSET English — C2 Proficiency", issuer: "EF Standard English Test", color: "#1A73E8", iconKey: "efset" },
];
    ...
    >
      ...
      >
        {PROJECTS.map((p, i) => {
          ...
          /* 5 items: top 3 span 2 cols each, bottom 2 offset by 1 col */
          let gridCol;
          if (!isLastRow) {
            gridCol = `${(i % 3) * 2 + 1} / span 2`;
          } else if (lastRowCount === 2) {
            const posInRow = i - lastRowStart;
            gridCol = `${posInRow * 2 + 2} / span 2`;
          } else {
            gridCol = `${(i % 3) * 2 + 1} / span 2`;
          }
          return (
      ...
      >
        {CERTS.map((c, i) => (
          ...
          >
            ...
            >
              {CERT_ICONS[c.iconKey] || (
                <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                  <path d="M10 2L12.09 7.26L18 8.27L13.8 12.14L14.94 18L10 15.27L5.06 18L6.2 12.14L2 8.27L7.91 7.26L10 2Z" fill={c.color} opacity="0.85"/>
                </svg>
              )}
            </div>
            <div>
    ...
    <style>{`
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      @media (max-width: 960px) {
        ...
        .pf-project-grid > * { grid-column: 1 / -1 !important; }
      }
